...
DESCRIPTION="Matomo is a downloadable, open source (GPL licensed) real time web analytics software program."
HOMEPAGE="http://www.matomo.org/"
SRC_URI="http://builds.matomo.org/matomo-${PV}.zip"
...
pkg_postinst() {
	...
	elog "http://matomo.org/docs/installation-optimization/"
	webapp_pkg_postinst
}
